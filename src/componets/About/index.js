...
function About() {
    return(
        <section className='title'>
            ...
            <p>
            Hello, my name is Ryan. I recently switched my education to web development and studied rigorously at Northwestern University. I wanted to challenge myself in new ways by exploring the world of coding. Web Development allows me to be creative and find ways to optimize certain processes. Everything and anything can always be improved and I enjoy being able to solve issues that challenge my mind!
            <br></br>
            <br></br>
